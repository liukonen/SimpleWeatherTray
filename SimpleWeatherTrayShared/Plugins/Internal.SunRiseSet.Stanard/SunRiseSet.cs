...
namespace ExternalService
{
    ...
    public class InternalSunRiseSet : IsharedSunRiseSetInterface
    {
      ...
      */
        ...
        MessageBox messageBox = MessageBox.Invoke();
        ...
        public Dictionary<string, EventHandler> SettingsItems() { return new Dictionary<string, EventHandler>() { { "Hour To Update", ChangehourToUpdate } }; }
        ...
        static bool IntialgetLatLong()
        {
            ...
            //{
                double lat = double.Parse(ibox.Show("Please Enter your Latitude", "Latitude"));
                double lon = double.Parse(ibox.Show("Please Enter your Longitude", "Longitude"));
        ...
        {
            Input ibox =  Input.Invoke();
            MessageBox msgBox = MessageBox.Invoke();
            int current;
            ...
            {
                string attempt;
                attempt = ibox.Show("Enter the hour you want to update the call to get sun rise, set info", "Hour update", current.ToString());
                SharedObjects.AppSettings.AddUpdateAppSettings("Hourupdate", int.Parse(attempt).ToString());
            }
            catch { msgBox.Show("Could not update, please try again"); }
        }
